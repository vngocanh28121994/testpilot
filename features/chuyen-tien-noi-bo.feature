...
Feature: Chuyển tiền nội bộ
  ...
  Scenario: Tiểu khoản đã chọn ở nguồn không xuất hiện ở dropdown đích
    Given I open feature "Chuyển tiền" from search
    When I select "TK Ký Quỹ" from "Chuyển từ"
    Then "TK Ký Quỹ" is not an option in "Chọn TK nhận tiền"
  ...
  Scenario: Số tiền được chuyển thay đổi theo tiểu khoản nguồn đã chọn
    Given I open feature "Chuyển tiền" from search
    When I remember "Được chuyển" as "soTienThuong"
  ...
  @p1 @positive
  Scenario: Nhập số tiền hợp lệ chuyển sang màn hình xác nhận
    Given I open feature "Chuyển tiền" from search
    When I select "TK Ký Quỹ" from "Chọn TK nhận tiền"
    And I enter "1000" into "Số tiền"
    And I click "Nút CHUYỂN"
  ...
  @p1 @positive
  Scenario: Bấm Quay lại trên màn xác nhận trở về màn hình Chuyển tiền
    Given I open feature "Chuyển tiền" from search
    When I select "TK Ký Quỹ" from "Chọn TK nhận tiền"
    And I enter "1000" into "Số tiền"
    And I click "Nút CHUYỂN"
  ...
  @p1 @positive
  Scenario: Số tiền được chuyển giảm tương ứng sau khi chuyển tiền thành công
    Given I open feature "Chuyển tiền" from search
    When I remember "Được chuyển" as "soTienTruoc"
    And I select "TK Ký Quỹ" from "Chọn TK nhận tiền"
    And I enter "1000" into "Số tiền"
    And I click "Nút CHUYỂN"
    And I click "Nút XÁC NHẬN"
    Then "Thông báo" shows "Chuyển tiền thành công"
    And "Được chuyển" decreased by "1000" from "soTienTruoc"
